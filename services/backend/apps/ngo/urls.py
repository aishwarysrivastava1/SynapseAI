...
urlpatterns = [
    ...
    path("volunteers/<str:volunteer_id>/profile",            views.VolunteerDetailView.as_view()),
    path("volunteers/<str:volunteer_id>/deactivate",         views.DeactivateVolunteerView.as_view()),
    ...
    path("resources/<str:resource_id>/allocate",             views.AllocateResourceView.as_view()),
    ...
    path("enrollment-requests",                              views.EnrollmentsView.as_view()),
    path("enrollment-requests/<str:enrollment_id>/approve",  views.EnrollmentActionView.as_view(), kwargs={"action": "approve"}),
    path("enrollment-requests/<str:enrollment_id>/reject",   views.EnrollmentActionView.as_view(), kwargs={"action": "reject"}),
